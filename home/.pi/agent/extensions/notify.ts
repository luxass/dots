 ...
 * Uses the OSC 777 escape sequence supported by Ghostty, iTerm2, WezTerm, and
 * rxvt-unicode. The notification body is derived from the latest assistant
 * message and flattened from Markdown to compact plain text.
 */
