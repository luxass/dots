...
complete -c dot -n '__fish_use_subcommand' -a pi -d 'Manage Pi, Pi extensions, and skills'
...
complete -c dot -n '__fish_seen_subcommand_from pi; and not __fish_seen_subcommand_from skills' -a 'status update skills extension help' -d 'Pi command'
complete -c dot -n '__fish_seen_subcommand_from pi; and __fish_seen_subcommand_from skills' -a 'add list help' -d 'Pi skills command'
